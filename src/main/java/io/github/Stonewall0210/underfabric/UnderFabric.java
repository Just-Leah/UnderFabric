...
public class UnderFabric implements ModInitializer {
	...
	public static final monsterCandy SNOWMAN_PIECE = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
	public static final monsterCandy NICE_CREAM = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
	public static final monsterCandy BISICLE = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
	public static final monsterCandy UNISICLE = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
	public static final monsterCandy CINNAMON_BUNNY = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
	public static final monsterCandy ASTRONAUT_FOOD = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
	public static final monsterCandy CRAB_APPLE = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
	public static final monsterCandy SEA_TEA = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
	public static final monsterCandy ABANDONED_QUICHE = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
	public static final monsterCandy TEMMIE_FLAKES = new monsterCandy(new FabricItemSettings().group(ItemGroup.FOOD));
