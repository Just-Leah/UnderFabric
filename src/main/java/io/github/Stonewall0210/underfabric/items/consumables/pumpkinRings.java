...
public class pumpkinRings extends Item {
    public pumpkinRings(Settings group) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        playerEntity.heal(8);
        if (world.isClient) {
            playerEntity.sendMessage(new TranslatableText("text.underfabric.pumpkin_rings.use"), false);
        }
