...
public class puppyIceCream extends Item {
    public puppyIceCream(Settings group) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        playerEntity.heal(28);
        if (world.isClient) {
            playerEntity.sendMessage(new TranslatableText("text.underfabric.puppy_ice_cream.use"), false);
        }
