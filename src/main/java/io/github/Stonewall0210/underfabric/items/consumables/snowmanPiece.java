...
public class snowmanPiece extends Item{
    public snowmanPiece(Item.Settings group) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        playerEntity.heal(45);
        if (world.isClient) {
            playerEntity.sendMessage(new TranslatableText("text.underfabric.snowman_piece.use"), false);
        }
