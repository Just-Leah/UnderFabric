...
public class cinnamonBunny extends Item{
    public cinnamonBunny(Item.Settings group) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        playerEntity.heal(22);
        if (world.isClient) {
            playerEntity.sendMessage(new TranslatableText("text.underfabric.cinnamon_bunny.use"), false);
        }
