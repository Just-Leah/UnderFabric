...
public class instantNoodles extends Item{
    public instantNoodles(Item.Settings group) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        playerEntity.heal(4);
        playerEntity.sendMessage(new TranslatableText("text.underfabric.instant_noodles.use"),false);
