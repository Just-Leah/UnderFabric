...
public class hushPuppy extends Item {
    public hushPuppy(Item.Settings group) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        playerEntity.heal(65);
        playerEntity.sendMessage(new TranslatableText("text.underfabric.hush_puppy.use"),false);
