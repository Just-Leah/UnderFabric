...
public class ghostFruit extends Item {
    public ghostFruit(Settings group) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if (world.isClient) {
            playerEntity.sendMessage(new TranslatableText("text.underfabric.ghost_fruit.use"), false);
        }
