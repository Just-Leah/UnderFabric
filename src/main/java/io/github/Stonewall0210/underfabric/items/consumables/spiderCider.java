...
public class spiderCider extends Item{
    public spiderCider(Item.Settings group) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        playerEntity.heal(24);
        if (world.isClient) {
            playerEntity.sendMessage(new TranslatableText("text.underfabric.spider_cider.use"), false);
        }
