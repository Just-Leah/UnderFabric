...
public class croquetRoll extends Item {
    public croquetRoll(Settings group) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if (world.isClient) {
            playerEntity.sendMessage(new TranslatableText("text.underfabric.croquet_roll.use"), false);
        }
